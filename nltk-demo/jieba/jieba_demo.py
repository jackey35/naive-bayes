...
#对分词的语料库制作成nltk 的text文档
wordlist = jieba.lcut(cleaned_data)
text = nltk.Text(wordlist)
print(text)


#print(text.concordance(word='绘画',width=20,lines=10))
print(text.similar(word='毒虫',num=10))

from nltk.text import ContextIndex
contentindex = ContextIndex(wordlist)
similarity_scores = contentindex.word_similarity_dict(word='盗墓')
for key,value in similarity_scores.items():
    if value>0.02:
        print(key,value)


print(text.count(word='不是'))